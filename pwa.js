...
// Paths are resolved relative to this script so PWA works on GitHub Pages
// (e.g. https://user.github.io/RepoName/) not only at domain root.
(function () {
  ...
  function showInstallHelp() {
    ...
    modal.style.cssText =
      "position:fixed;inset:0;background:rgba(0,0,0,.62);z-index:2147483647;display:flex;align-items:center;justify-content:center;padding:16px;";
    modal.innerHTML = `
